  ...
  return (
    <>
      <div className="w-full bg-white dark:bg-[#1a1c1a] py-16 border-y border-stone-100 dark:border-stone-800 relative overflow-hidden flex flex-col gap-6">
        ...
        <div className="flex overflow-hidden group">
          <div className="flex gap-6 animate-marquee-reverse shrink-0 items-center pr-6 group-hover:[animation-play-state:paused]">
            {ROW_2.map((item) => (
              <Bubble key={item.id} item={item} onSelect={setSelectedProblem} />
            ))}
          </div>
          ...
          >
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <div className="mt-8">
                  <a
                    href={`https://wa.me/918010777641?text=${encodeURIComponent(`Hii Ma'am, in the recent days I have been facing issues related to ${selectedProblem.text}. It's been affecting me and I would really like to talk about it. Can we have a conversation? 🙏`)}`}
                    target="_blank"
                    rel="noreferrer"

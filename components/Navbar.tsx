...
interface NavbarProps {
  ...
  onLoginClick?: () => void; // Optional as Landing doesn't show login button in header usually
  isDark: boolean;
  onThemeToggle: () => void;
              ...
              <nav className="flex flex-col gap-2">
                  ...
                  {onLoginClick && (
                    <button 
                        ...
                        className="p-4 text-left text-lg font-medium rounded-xl text-brand-orange hover:bg-orange-50 dark:hover:bg-orange-900/10 transition-colors mt-2 border-t border-stone-100 dark:border-stone-800"
                    >
                        Counselor Login
                    </button>
                  )}

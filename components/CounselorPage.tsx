        ...
        <div className="flex flex-col md:flex-row gap-12 items-start mb-24">
          <div className="w-full md:w-1/3 flex flex-col items-center">
             ...
             <div className="text-center w-full">
               <h1 className="text-2xl font-bold text-stone-900 dark:text-white mb-2">Dr. Anjali Deshmukh</h1>
               <p className="text-[#4a8067] dark:text-[#6ccca2] font-medium mb-6">Senior Student Counsellor</p>
               
               <div className="flex flex-wrap gap-2 justify-center">
                  <span className="px-3 py-1 bg-white dark:bg-[#252525] border border-stone-200 dark:border-stone-800 text-stone-600 dark:text-stone-300 text-xs rounded-full font-medium">Ph.D. Psychology</span>
                  <span className="px-3 py-1 bg-white dark:bg-[#252525] border border-stone-200 dark:border-stone-800 text-stone-600 dark:text-stone-300 text-xs rounded-full font-medium">15+ Years Exp</span>
               </div>
             </div>
          </div>
          ...
          <div className="w-full md:w-2/3 space-y-8">
            ...
            <div className="grid sm:grid-cols-2 gap-4">
                <div className="p-5 bg-white dark:bg-[#252525] rounded-2xl border border-stone-100 dark:border-stone-800 shadow-sm">
                    ...
                    <p className="text-sm text-stone-500 dark:text-stone-400 leading-relaxed">Ph.D. in Clinical Psychology from TISS, Mumbai. Specialized in Adolescent Mental Health.</p>
                </div>
                 <div className="p-5 bg-white dark:bg-[#252525] rounded-2xl border border-stone-100 dark:border-stone-800 shadow-sm">
                    <div className="flex items-center gap-3 mb-2">
